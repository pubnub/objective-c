...
struct PNLoggerSymbolsStructure {
    ...
    struct {
        ...
        struct {
            ...
            __unsafe_unretained NSString *leaveRequeXCTFailed;
        ...
        struct {
            ...
            // Parameters requirements: [code, connection channel name, PNError instance]
            __unsafe_unretained NSString *timeTokenRequeXCTFailed;
            ...
            __unsafe_unretained NSString *clientStateAuditRequeXCTFailed;

            // Parameters requirements: [code, connection channel name, PNClient instance]
            __unsafe_unretained NSString *clientStateUpdateRequestCompleted;

            // Parameters requirements: [code, connection channel name, PNError instance, PNClient instance]
            __unsafe_unretained NSString *clientStateUpdateRequeXCTFailed;
            ...
            __unsafe_unretained NSString *messageSendRequeXCTFailed;
            ...
            __unsafe_unretained NSString *historyRequeXCTFailed;

            // Parameters requirements: [code, connection channel name, PNChannel instance, whether client identifiers should be pulled, whether clien't state should be pulled, list of PNClient instances]
            __unsafe_unretained NSString *participantsListRequestCompleted;

            // Parameters requirements: [code, connection channel name, PNChannel instance, whether client identifiers should be pulled, whether clien't state should be pulled, PNError instance]
            __unsafe_unretained NSString *participantsListRequeXCTFailed;
            ...
            __unsafe_unretained NSString *participantChannelsListRequeXCTFailed;
            ...
            __unsafe_unretained NSString *pushNotificationEnableRequeXCTFailed;

            // Parameters requirements: [code, connection channel name, NSData instance, list of PNChannel instances]
            __unsafe_unretained NSString *pushNotificationDisableRequestCompleted;

            // Parameters requirements: [code, connection channel name, NSData instance, list of PNChannel instances, PNError instance]
            __unsafe_unretained NSString *pushNotificationDisableRequeXCTFailed;
            ...
            __unsafe_unretained NSString *pushNotificationRemoveRequeXCTFailed;

            // Parameters requirements: [code, connection channel name, NSData instance, list of PNChannel instances]
            __unsafe_unretained NSString *pushNotificationsAuditRequestCompleted;

            // Parameters requirements: [code, connection channel name, NSData instance, PNError instance]
            __unsafe_unretained NSString *pushNotificationsAuditRequeXCTFailed;
            ...
            __unsafe_unretained NSString *accessRightsChangeRequeXCTFailed;
            ...
            __unsafe_unretained NSString *accessRightsAuditRequeXCTFailed;
    ...
    struct {
        ...
        // Parameters requirements: [code, PNChannel instance, whether client identifiers should be included, stringified state]
