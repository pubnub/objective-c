...
struct PNLoggerSymbolsStructure PNLoggerSymbols = {
    ...
    .connectionChannel = {
        ...
        .service = {
            ...
            .timeTokenRequeXCTFailed = @"0202003",
            .clientStateAuditRequestCompleted = @"0202004",
            .clientStateAuditRequeXCTFailed = @"0202005",
            .clientStateUpdateRequestCompleted = @"0202006",
            .clientStateUpdateRequeXCTFailed = @"0202007",
            .messageSendRequestCompleted = @"0202008",
            .messageSendRequeXCTFailed = @"0202009",
            .historyRequestCompleted = @"0202010",
            .historyRequeXCTFailed = @"0202011",
            .participantsListRequestCompleted = @"0202012",
            .participantsListRequeXCTFailed = @"0202013",
            .participantChannelsListRequestCompleted = @"0202014",
            .participantChannelsListRequeXCTFailed = @"0202015",
            .pushNotificationEnableRequestCompleted = @"0202016",
            .pushNotificationEnableRequeXCTFailed = @"0202017",
            .pushNotificationDisableRequestCompleted = @"0202018",
            .pushNotificationDisableRequeXCTFailed = @"0202019",
            .pushNotificationRemoveRequestCompleted = @"0202020",
            .pushNotificationRemoveRequeXCTFailed = @"0202021",
            .pushNotificationsAuditRequestCompleted = @"0202022",
            .pushNotificationsAuditRequeXCTFailed = @"0202023",
            .accessRightsChangeRequestCompleted = @"0202024",
            .accessRightsChangeRequeXCTFailed = @"0202025",
            .accessRightsAuditRequestCompleted = @"0202026",
            .accessRightsAuditRequeXCTFailed = @"0202027",
            .parsedData = @"0202028",
