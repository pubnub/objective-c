...
/**
 Retrieve client metadata information from \b PubNub service.
...
/**
 ...
 @code
 @endcode
 This method extends \a +updateClientMetadata:metadata:forChannel: and allow to specify metadata update process
 handling block.
...
/**
 ...
 @code
 @endcode
 This method extends \a +subscribeOnChannel:withPresenceEvent:metadata: and allow to specify subscription process state
...
/**
 ...
 @code
 @endcode
 This method extends \a +subscribeOnChannels:withPresenceEvent:metadata: and allow to specify subscription process
...
/**
 ...
 @note This method by default won't request client's metadata.
