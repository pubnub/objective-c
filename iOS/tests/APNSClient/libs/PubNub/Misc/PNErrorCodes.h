...
static NSInteger const kPNAPIUnauthorizedAccessError = 119;

// PubNub service reported that wrong authorization has been used for request
static NSInteger const kPNAPIAccessForbiddenError = 120;

/**
 \b PubNub service reported that requested API not enabled or not available.
 */
static NSInteger const kPNAPINotAvailableOrNotEnabledError = 121;

/**
 Scheduled request can't be processed w/o initial API calling based on object data.
 */
static NSInteger const kPNRequestCantBeProcessedWithOutRescheduleError = 122;
