...
-(void)testPercentEscapedString {
	...
	STAssertTrue( [[string pn_percentEscapedString] isEqualToString: @"%3Aasdf%2Fasdf%3Fasdf%23sadf%5Bb%20sg%5Ds%20g%40as%20rg%21srt%24re%26g%E2%80%99rqreqge%28%20sg%29sdfgh%2A%20stght%2B%20h%2Csth%3Ba%3Da%40%24%25%5E%40%24%26"] == YES, @"");
...
-(void)testASCIIString {
	NSString *string = @":asdf/asdf?asdf#sadf[b sg]s g@as rg!srt$re&g’rqreqge( sg)sdfgh* stght+ h,sth;a=a@$%^@$&";
	STAssertTrue( [[string pn_ASCIIString] isEqualToString: @"58971151001024797115100102639711510010235115971001029198321151039311532103649711532114103331151141163611410138103821711411311410111310310140321151034111510010210310442321151161031041164332104441151161045997619764363794643638"] == YES, @"");

	STAssertTrue( [[string pn_ASCIIHEXString] isEqualToString: @"3A617364662F617364663F6173646623736164665B622073675D732067406173207267217372742472652667201972717265716765282073672973646667682A2073746768742B20682C7374683B613D614024255E402426"] == YES, @"");
