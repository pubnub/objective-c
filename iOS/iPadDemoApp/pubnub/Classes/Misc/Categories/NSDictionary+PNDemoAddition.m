...
@interface NSDictionary (PNDemoAdditionPrivate)
...
@implementation NSDictionary (PNDemoAddition)
...
- (NSString *)logDescription {
    ...
    [self enumerateKeysAndObjectsUsingBlock:^(NSString *entryKey, id entry, BOOL *entryEnumeratorStop) {
        ...
        logDescription = [logDescription stringByAppendingFormat:@"%@:%@%@", entryKey, entry,
