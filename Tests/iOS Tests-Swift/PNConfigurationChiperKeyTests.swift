...
class PNConfigurationChiperKeyTests: PNBasicClientCryptTestCase {
    ...
    func testHistoryWithChiperKey() {
        ...
        self.cryptedClient.historyForChannel(self.channelString, withCompletion: { (result: PNHistoryResult!, status: PNErrorStatus!) -> Void in
    ...
    func testHistoryWithChiperKeyOnlyCryptedMessages() {
        ...
        self.cryptedClient.historyForChannel(self.cryptedChannelName, withCompletion: { (result: PNHistoryResult!, status: PNErrorStatus!) -> Void in
