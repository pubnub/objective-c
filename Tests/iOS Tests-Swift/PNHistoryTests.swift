...
class PNHistoryTests: PNBasicClientTestCase {
    ...
    func testHistory() {
        ...
        self.client.historyForChannel("a", start:14356962344283504, end:14356962619609342, withCompletion: { (result, status) -> Void in
            XCTAssertNil(status)
            XCTAssertNotNil(result)
            XCTAssertEqual(result.statusCode, 200)
            XCTAssertEqual(result.data.start, 14356962364490888)
            XCTAssertEqual(result.data.end, 14356962609521455)
    ...
    func testHistoryWithTimeToken() {
        ...
        self.client.historyForChannel("a", start:14356962344283504, end:14356962619609342, includeTimeToken:true, withCompletion: { (result, status) -> Void in
            XCTAssertNil(status)
            XCTAssertNotNil(result)
            XCTAssertEqual(result.statusCode, 200)
            XCTAssertEqual(result.data.start, 14356962364490888)
    ...
    func testHistoryWithLimit() {
        ...
        self.client.historyForChannel("a", start:14356962344283504, end:14356962619609342, limit:3, withCompletion: { (result, status) -> Void in
            XCTAssertNil(status)
            XCTAssertNotNil(result)
            XCTAssertEqual(result.statusCode, 200)
            XCTAssertEqual(result.data.start, 14356962364490888)
            XCTAssertEqual(result.data.end, 14356962405294305)
            XCTAssertEqual(result.operation, PNOperationType.HistoryOperation)
            // might want to assert message array is exactly equal, for now just get count
            XCTAssertNotNil(result.data.messages)
    ...
    func testHistoryWithLimitAndTimeToken() {
        ...
        self.client.historyForChannel("a", start:14356962344283504, end:14356962619609342, limit:3, includeTimeToken:true, withCompletion: { (result, status) -> Void in
            XCTAssertNil(status)
            XCTAssertNotNil(result)
            XCTAssertEqual(result.statusCode, 200)
            XCTAssertEqual(result.data.start, 14356962364490888)
