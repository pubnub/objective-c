...
- (void)subscribeToChannels:(NSArray *)channels withPresence:(BOOL)shouldObservePresence
    ...
    [self.subscriberManager subscribe:YES usingTimeToken:timeToken withState:state region:nil completion:nil];
}
...
- (void)subscribeToPresenceChannels:(NSArray *)channels {
    ...
    [self.subscriberManager subscribe:YES usingTimeToken:nil withState:nil region:nil completion:nil];
}
