 ...
 *
 * @discussion Instance allow to translate operation type and parameters to valid URL which should
 ...
 *
 * @param operation One of \b PNOperationType fields which describes operation type (to choose
 *     correct API endpoint).
 * @param parameters Object which represent set of parameters which should be used during path
 *     composition.
 *
 ...
 * @param operation One of \b PNOperationType fields which describes operation type against which
