...
- (instancetype)initWithPublishKey:(NSString *)publishKey subscribeKey:(NSString *)subscribeKey {
    ...
    if ((self = [super init])) {
        ...
        _notifyAboutFailedHeartbeatsOnly = kPNDefaultShouldNotifyAboutFailedHeartbeatsOnly;
...
- (id)copyWithZone:(NSZone *)zone {
    ...
    configuration.notifyAboutFailedHeartbeatsOnly = self.shouldNotifyAboutFailedHeartbeatsOnly;
