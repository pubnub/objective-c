 ...
 */
@interface PNSetMembersAPICallBuilder : PNObjectsAPICallBuilder
 ...
 */
@property (nonatomic, readonly, strong) PNSetMembersAPICallBuilder * (^includeFields)(PNMemberFields includeFields);
 ...
 * @return API call configuration builder.
 */
@property (nonatomic, readonly, strong) PNSetMembersAPICallBuilder * (^uuids)(NSArray<NSDictionary *> *uuids);
 ...
 * @return API call configuration builder.
 */
@property (nonatomic, readonly, strong) PNSetMembersAPICallBuilder * (^includeCount)(BOOL shouldIncludeCount);
 ...
 * @return API call configuration builder.
 */
@property (nonatomic, readonly, strong) PNSetMembersAPICallBuilder * (^sort)(NSArray<NSString *> *sort);
 ...
 * @return API call configuration builder.
 */
@property (nonatomic, readonly, strong) PNSetMembersAPICallBuilder * (^filter)(NSString *filter);
 ...
 * @return API call configuration builder.
 */
@property (nonatomic, readonly, strong) PNSetMembersAPICallBuilder * (^limit)(NSUInteger limit);
 ...
 * @return API call configuration builder.
 */
@property (nonatomic, readonly, strong) PNSetMembersAPICallBuilder * (^start)(NSString *start);
 ...
 * @return API call configuration builder.
 */
@property (nonatomic, readonly, strong) PNSetMembersAPICallBuilder * (^end)(NSString *end);
 ...
 * @return API call configuration builder.
 */
@property (nonatomic, readonly, strong) PNSetMembersAPICallBuilder * (^queryParam)(NSDictionary *params);
