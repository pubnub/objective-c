...
/**
 * @brief Object which is used to represent Objects API response for create user request.
 *
...
/**
 * @brief Object which is used to provide access to processed create user request results.
 *
 * @author Serhii Mamontov
 * @version 4.10.0
 * @since 4.10.0
