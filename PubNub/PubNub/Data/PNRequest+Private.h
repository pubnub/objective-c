...
@property (nonatomic, copy) void(^completionBlock)(PNRequest *request);
...
+ (instancetype)requestWithPath:(NSString *)resourcePath parameters:(NSDictionary *)queryParameters
                   forOperation:(PNOperationType)type
                 withCompletion:(void (^)(PNRequest *request))block;
...
- (instancetype)initWithPath:(NSString *)resourcePath parameters:(NSDictionary *)queryParameters
                forOperation:(PNOperationType)type withCompletion:(void (^)(PNRequest *request))block;
