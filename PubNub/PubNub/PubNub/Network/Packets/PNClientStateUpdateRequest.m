...
- (NSString *)resourcePath {
    ...
    return [[NSString alloc] initWithFormat:@"/v2/presence/sub-key/%@/channel/%@/uuid/%@/data?callback=%@_%@&state=%@%@%@&pnsdk=%@",
            ...
            (self.channel.isChannelGroup ? [[NSString alloc] initWithFormat:@"&channel-group=%@", [self.channel escapedName]] : @""),
