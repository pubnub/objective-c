...
- [Beta API Reference](#beta-api-reference)
  - [Initialization](#initialization)
    - [Step 0 - Basic Setup](#step-0---basic-setup)
    ...
    - [Step 2 - Instantiate a Client Instance with a Config](#step-2---instantiate-a-client-instance-with-a-config)
    ...
    - [Step 3 - Add a Listener in order to Receive Subscribe and Presence Stream Events](#step-3---add-a-listener-in-order-to-receive-subscribe-and-presence-stream-events)
  - [Time](#time)
  - [Publish](#publish)
