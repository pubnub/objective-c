...
This is Objective-C client (current version **3.7.8**) for the [PubNub.com](http://www.pubnub.com/) real-time messaging network which can be used for iOS 6.1+ and Mac OS 10.6+ projects.  
...
<a/>3. Update the configuration instance using this next set of parameters:  
  ...
  ***Please consult with PubNub support before setting this value lower than the default to avoid incurring additional charges.***
  ...
  - <a href="https://github.com/pubnub/objective-c/blob/master/README.md" id="presenceHeartbeatTimeout">presenceHeartbeatTimeout</a>
