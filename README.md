...
- [Beta API Reference](#beta-api-reference)
  - [Initialization](#initialization)
    ...
    - [Create a Config](#create-a-config)
      - [[+ configurationWithPublishKey:subscribeKey:](https://rawgit.com/pubnub/objective-c/4.0b3/docs/data/html/Classes/PNConfiguration.html)](#-configurationwithpublishkeysubscribekeyhttpsrawgitcompubnubobjective-c40b2docsdatahtmlclassespnconfigurationhtml)
